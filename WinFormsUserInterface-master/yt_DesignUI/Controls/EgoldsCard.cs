...
namespace Zanetki_design
{
    public class EgoldsCard : Control
    {
        ...
        {
            List<string> list = (new string[] { "Как создать новую заметку? - Нажмите на кнопку | новая заметка | --> введите все нужные данные и сохраните ее ", "Создали заметку, но не можете найти ее? - Нажмите на кнопку | история заметок | --> и увидите список всех ваших заметок " }).ToList();
        }
