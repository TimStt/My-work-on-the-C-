...
namespace EgoldsUI
{
    public static class FlatColors
    {
        ...
        public static Color RedWhite = ColorTranslator.FromHtml("#e47070");

        public static Color Turquoise = ColorTranslator.FromHtml("#78bbc7");
        public static Color PinkLight = ColorTranslator.FromHtml("#eee7f6");
        ...
        public static Color purpleWhite = ColorTranslator.FromHtml("#5990c2");
